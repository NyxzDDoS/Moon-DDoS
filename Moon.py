...
wms = [
  ...
  '''                                           
       `7MMM.     ,MMF'                             
         MMMb    dPMM                               
         M YM   ,M MM  ,pW"Wq.   ,pW"Wq.`7MMpMMMb.  
         M  Mb  M' MM 6W'   `Wb 6W'   `Wb MM    MM  
         M  YM.P'  MM 8M     M8 8M     M8 MM    MM  
         M  `YM'   MM YA.   ,A9 YA.   ,A9 MM    MM  
       .JML. `'  .JMML.`Ybmd9'   `Ybmd9'.JMML  JMML.
  ''',

  '''                                         
    ooo        ooooo                                 
    `88.       .888'                                 
     888b     d'888   .ooooo.   .ooooo.  ooo. .oo.   
     8 Y88. .P  888  d88' `88b d88' `88b `888P"Y88b  
     8  `888'   888  888   888 888   888  888   888  
     8    Y     888  888   888 888   888  888   888  
    o8o        o888o `Y8bod8P' `Y8bod8P' o888o o888o 
  ''',
